# MULTI-PRECISION TOOLKIT & CRYPTOLOGY STUFF

I was interested in low-level multi-precision arithmetic, as well as cryptographic primitives and methods we are learning in my degree.
...
> I try to limit as much as possible AI code. I may use it to find bugs or write graphical/IO code, but not for the interesting parts. My principal objective is to **code myself and really understand**.
>
> I use it massively to quickly create checks and benchmarks too.
>
> It is still a great tool to find and understand methods, and I don't see real issues using it for this purpose.
